import React, { createContext, useRef, useContext, useMemo, useDebugValue, useEffect, useLayoutEffect, useState } from 'react';
...
const TimeColumn = ({ start, end, setValue, value, exclude, notShowExclude }) => {
    ...
    const [slecetorMove, setSlecetorMove] = useState(+value ? +value : 0);
    const timeArray = [];
...
const Timeit = ({ onChange, defaultValue, minuteExclude, hourExclude, notShowExclude, }) => {
    ...
    return (jsxRuntime.exports.jsxs("div", Object.assign({ className: classes.wrapper }, { children: [jsxRuntime.exports.jsx(TimeColumn, { notShowExclude: notShowExclude, start: 0, end: 60, value: hour, setValue: setHour, exclude: hourExclude }, void 0), jsxRuntime.exports.jsx(TimeColumn, { notShowExclude: notShowExclude, start: 0, end: 59, value: minute, setValue: setMinute, exclude: minuteExclude }, void 0)] }), void 0));
};
